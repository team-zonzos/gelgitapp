...
(1, 'indirim10', 0.10, '2024-08-31', '2023-02-01', 'public' ),
(2, 'indirim20', 0.20, '2024-08-31', '2023-02-01', 'public' ),
(3, 'indirim30', 0.30, '2024-08-31', '2023-02-01', 'public' ),
(4, 'indirim10', 0.10, '2024-12-31', '2023-02-02', 'private' ),
(5, 'indirim20', 0.20, '2024-12-31', '2023-02-02', 'private' ),
(6, 'indirim30', 0.30, '2024-12-31', '2023-02-02', 'private' );
...
(1, 4, 1, 3, '2024-06-20 10:00:00', '2024-06-20 12:00:00', 1000.00, 1399.00, 3),
(2, 4, 3, 1, '2024-06-20 13:00:00', '2024-06-20 15:00:00', 1000.00, 1399.00, 3),
(3, 4, 3, 4, '2024-08-20 19:00:00', '2024-08-20 21:00:00', 900.00, 1299.00, 4),
(4, 4, 3, 4, '2024-04-12 18:00:00', '2024-04-12 20:00:00', 900.00, 1299.00, 3),
(5, 4, 5, 10, '2024-06-25 09:00:00', '2024-06-25 15:00:00', 300.00, NULL, 1),
(6, 4, 16, 13, '2024-06-25 09:00:00', '2024-06-25 16:00:00', 300.00, NULL, 2),
(7, 5, 1, 3, '2024-06-20 10:00:00', '2024-06-20 12:00:00', 1300.00, 1799.00, 3),
(8, 5, 3, 1, '2024-06-20 13:00:00', '2024-06-20 15:00:00', 1000.00, 1399.00, 3),
(9, 5, 3, 4, '2024-08-20 19:00:00', '2024-08-20 21:00:00', 1000.00, 1299.00, 4),
(10, 5, 3, 4, '2024-04-12 20:00:00', '2024-04-12 22:00:00', 900.00, 1299.00, 3),
(11, 5, 5, 18, '2024-06-06 09:00:00', '2024-06-25 15:00:00', 350.00, NULL, 2),
(12, 5, 16, 13, '2024-06-25 09:00:00', '2024-06-25 16:00:00', 350.00, NULL, 2),
(13, 5, 5, 18, '2024-06-25 09:00:00', '2024-06-25 13:00:00', 200.00, NULL, 2),
(14, 6, 1, 3, '2024-06-20 10:00:00', '2024-06-20 12:00:00', 1200.00, 1699.00, 3),
(15, 6, 3, 1, '2024-06-20 13:00:00', '2024-06-20 15:00:00', 900.00, 1199.00, 3),
(16, 6, 3, 4, '2024-08-20 19:00:00', '2024-08-20 21:00:00', 800.00, 1199.00, 4),
(17, 6, 3, 4, '2024-04-12 19:00:00', '2024-04-12 21:00:00', 800.00, 1199.00, 3),
(18, 6, 5, 10, '2024-06-25 09:00:00', '2024-06-25 15:00:00', 250.00, NULL, 1),
(19, 6, 16, 13, '2024-06-25 09:00:00', '2024-06-25 16:00:00', 250.00, NULL, 2),
(20, 6, 5, 18, '2024-06-06 09:00:00', '2024-06-25 13:00:00', 150.00, NULL, 2);
...
CREATE TABLE Purchased(
	...
	PRIMARY KEY(PNR),
	FOREIGN KEY (PNR) REFERENCES Booking(PNR) ON DELETE CASCADE,
	FOREIGN KEY (coupon_id) REFERENCES Sale_Coupon(coupon_id) ON DELETE SET NULL
);
...
CREATE TABLE Travels_In_Journey(
	...
	FOREIGN KEY (journey_name) REFERENCES Journey(journey_name) ON DELETE CASCADE,
	FOREIGN KEY (traveler_id) REFERENCES Traveler(id) ON DELETE CASCADE,
